...
class ProjectTests(unittest.TestCase):
    ...
    def test_edit_project(self):
        ...
        response = self.client.post(f'/project/{project.id}/edit', data={
        ...
        self.assertIn('project updated successfully!', response.get_data(as_text=True).lower())
    ...
    def test_delete_project(self):
        ...
        response = self.client.post(f'/project/{project.id}/delete', follow_redirects=True)
        self.assertIn('project has been deleted.', response.get_data(as_text=True).lower())
